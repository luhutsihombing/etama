            ...
            <nav id="sidebar" className="sidebar">
                <div className="sidebar-content ">
                    <a className="sidebar-brand" href="index.html">
                        ...
                        <span className="align-middle">ETAMA</span>
                    </a>
                    ...
                    <ul className="sidebar-nav">
                        ...
                        <li className="sidebar-item active">
                            ...
                            <ul id="dashboards" className="sidebar-dropdown list-unstyled collapse show" data-parent="#sidebar">
                                <li className="sidebar-item"><a className="sidebar-link" href="dashboard">Home <span
                                    className="sidebar-badge badge badge-primary">New</span></a></li>
                                <li className="sidebar-item"><a className="sidebar-link" href="admin">Report</a>
                                </li>
                                <li className="sidebar-item"><a className="sidebar-link"
                                                                href="setting">Setting</a></li>
                                <li className="sidebar-item"><a className="sidebar-link"
                                                                href="login">Login</a></li>
                                <li className="sidebar-item"><a className="sidebar-link" href="admin">Admin</a></li>

                            </ul>
                        </li>
                        <li className="sidebar-item">
                            <a href="#pages" data-toggle="collapse" className="sidebar-link collapsed">
                                <i className="align-middle" data-feather="layout"></i> <span className="align-middle">Master Setup</span>
                            </a>
                            <ul id="pages" className="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                                <li className="sidebar-item"><a className="sidebar-link" href="pages-profile.html">Truck</a></li>
                                <li className="sidebar-item"><a className="sidebar-link" href="pages-settings.html">User Management</a></li>
                                <li className="sidebar-item"><a className="sidebar-link" href="pages-clients.html">Group Management</a></li>
                            </ul>
                        </li>
                        <li className="sidebar-item">
                            <a href="#auth" data-toggle="collapse" className="sidebar-link collapsed">
                                <i className="align-middle" data-feather="users"></i> <span className="align-middle">Order Trucking</span>
                            </a>
                            <ul id="auth" className="sidebar-dropdown list-unstyled collapse" data-parent="#sidebar">
                                <li className="sidebar-item"><a className="sidebar-link" href="pages-sign-in.html">PO</a></li>
                                <li className="sidebar-item"><a className="sidebar-link" href="pages-sign-up.html">Surat jalan</a></li>
                                <li className="sidebar-item"><a className="sidebar-link" href="pages-reset-password.html">Delivery note</a></li>

                            </ul>
                        </li>
                        <li className="sidebar-item">
                            <a href="#layouts" data-toggle="collapse" className="sidebar-link collapsed">
                                <i className="align-middle" data-feather="monitor"></i> <span className="align-middle">Layouts</span>
                            </a>
                            <ul id="layouts" className="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                                <li className="sidebar-item"><a className="sidebar-link" href="layouts-sidebar-sticky.html">Sticky
                                    Sidebar</a></li>
                                <li className="sidebar-item"><a className="sidebar-link" href="layouts-sidebar-collapsed.html">Collapsed
                                    Sidebar</a></li>
                                <li className="sidebar-item"><a className="sidebar-link" href="layouts-boxed.html">Boxed Layout</a>
                                </li>
                                <li className="sidebar-item"><a className="sidebar-link"
                                                                href="dashboard-analytics.html?theme=classic">Classic Theme</a></li>
                                <li className="sidebar-item"><a className="sidebar-link"
                                                                href="dashboard-analytics-2.html?theme=corporate">Corporate
                                    Theme <span className="sidebar-badge badge badge-primary">New</span></a></li>
                                <li className="sidebar-item"><a className="sidebar-link"
                                                                href="dashboard-analytics-3.html?theme=modern">Modern Theme <span
                                    className="sidebar-badge badge badge-primary">New</span></a></li>
                            </ul>
                        </li>
                        <li className="sidebar-item">
                            <a href="#documentation" data-toggle="collapse" className="sidebar-link collapsed">
                                <i className="align-middle" data-feather="book-open"></i> <span
                                className="align-middle">Documentation</span>
                            </a>
                            <ul id="documentation" className="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                                ...
                                <li className="sidebar-item"><a className="sidebar-link" href="docs-installation.html">Getting
                                    Started</a></li>
                        ...
                        <li className="sidebar-item">
                            ...
                            <ul id="forms" className="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                                ...
                                <li className="sidebar-item"><a className="sidebar-link" href="forms-basic-elements.html">Basic
                                    Elements</a></li>
                                <li className="sidebar-item"><a className="sidebar-link" href="forms-advanced-elements.html">Advanced
                                    Elements</a></li>
                                ...
                                <li className="sidebar-item"><a className="sidebar-link" href="forms-validation.html">Validation</a>
                                </li>
                                <li className="sidebar-item"><a className="sidebar-link" href="forms-wizard.html">Wizard</a></li>
                            </ul>
                        </li>
                        <li className="sidebar-item">
                            <a href="#tables" data-toggle="collapse" className="sidebar-link">
                                <i className="align-middle" data-feather="list"></i> <span className="align-middle">Tables</span>
                            </a>
                            <ul id="tables" className="sidebar-dropdown list-unstyled collapse show" data-parent="#sidebar">
                                <li className="sidebar-item"><a className="sidebar-link" href="tables-bootstrap.html">Bootstrap</a>
                                </li>
                                <li className="sidebar-item"><a className="sidebar-link"
                        ...
                        <li className="sidebar-item">
                            <a href="#multi" data-toggle="collapse" className="sidebar-link">
                                <i className="align-middle" data-feather="share-2"></i> <span
                    ...
                    <div className="sidebar-bottom d-none d-lg-block">
                        <div className="media">
                            <img className="rounded-circle mr-3" src="img\avatars\avatar.jpg" alt="Chris Wood" width="40"
                                 height="40" />
