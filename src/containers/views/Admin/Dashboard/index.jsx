                                      ...
                                      <a href="#" className="list-group-item">
                                          <div className="row no-gutters align-items-center">
                                              ...
                                              <div className="col-10">
                                                  ...
                                                  <div className="text-muted small mt-1">Aliquam ex eros, imperdiet vulputate hendrerit et.
                                                  </div>
                  ...
                  <div className="container-fluid p-0">
                      ...
                      <div className="row">
                          <div className="col-12">
                              <div className="card">
                                  <div className="card-header">
                                      ...
                                      <h6 className="card-subtitle text-muted">Highly flexible tool that many advanced features to any
                                          HTML table.</h6>
                                  </div>
                                  <div className="card-body">
                                      <table style={{width: '100%'}} id="datatables-basic" className="table table-striped">
                                          <thead>
                                          <tr>
                                              <th>Name</th>
                                              <th>Position</th>
                          ...
                          <div className="col-12">
                              <div className="card">
                                  <div className="card-header">
                                      ...
                                      <h6 className="card-subtitle text-muted">This extension provides a framework with common options
                                          that can be used with DataTables.</h6>
                                  </div>
                                  <div className="card-body">
                                      <table  style={{width: '100%'}} id="datatables-buttons" className="table table-striped">
                                          <thead>
                                          <tr>
                                              <th>Name</th>
                                              <th>Position</th>
                          ...
                          <div className="col-12">
                              <div className="card">
                                  <div className="card-header">
                                      <h5 className="card-title">Table with Multi Selection</h5>
                                      <h6 className="card-subtitle text-muted">This example shows the multi option. Note how a click on
                                          a row will toggle its selected state without effecting other rows, unlike the os and single
                                          options
                                          shown in other examples.</h6>
                                  </div>
                                  <div className="card-body">
                                      <table style={{width: '100%'}}  id="datatables-multi" className="table table-striped">
                                          <thead>
                                          <tr>
                                              <th>Name</th>
                                              <th>Position</th>
